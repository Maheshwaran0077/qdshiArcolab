 ...
 */
const sendShiftMissedAlert = async ({ hodEmail, hodName, dept, shift, missedModules, date, startTime, endTime }) => {
...
<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;">
  ...
  <div style="background:white;padding:24px;border:1px solid #e2e8f0;border-top:none;border-radius:0 0 12px 12px;">
    <p style="color:#334155;font-size:14px;">Dear <strong>${hodName || 'HOD'}</strong>,</p>
    ...
    <p style="color:#334155;font-size:14px;">Please follow up with the responsible supervisor immediately.</p>
